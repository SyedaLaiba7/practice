...
function HomePage() {
  ...
  <button className='bg-[#FF9F0D] text-white w-[100px] h-[30px] md:w-[190px] md:h-[60px] rounded-[40px] mt-[32px] hover:bg-yellow-800'>
    See More
      ...
      <div className="mt-[50px] md:mt-0 ">
        <img src= "foodpic1" alt="Hero Image" className="" width={336} height={536} />
        <div className="flex flex-col md:flex-row mt-[16px] md:mt-[0]">
          <img src="foodpic2" alt="Hero Image" className="mr-[16px] pt-[40px]" />
          <img src="foodpic3" alt="Hero Image" className="pt-[40px]" />
        </div>
      </div>
    </section>
    <FoodCategory/>
